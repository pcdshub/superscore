...
def linac_data():
    lasr_gunb_pv1 = Parameter(
        uuid=UUID("5544c58f-88b6-40aa-9076-f180a44908f5"),
    ...
    lasr_gunb_pv2 = Parameter(
        uuid=UUID("7cb3760c-793c-4974-a8ae-778e5d491e4a"),
    ...
    lasr_gunb_col = Collection(
        uuid=UUID("d5bade05-d992-4e44-87d8-0db2937209bf"),
    ...
    mgnt_gunb_pv = Parameter(
        uuid=UUID("930b137f-5ae2-470e-8b82-c4b4eb7e639e"),
    ...
    mgnt_gunb_col = Collection(
        uuid=UUID("981d52d1-4d3c-4f85-89d7-8c04a0d588d0"),
    ...
    vac_gunb_pv1 = Parameter(
        uuid=UUID("8f3ac401-68f8-4def-b65a-3c8116c80ba7"),
    ...
    vac_gunb_pv2 = Parameter(
        uuid=UUID("06448272-cd38-4bb4-9b8d-292673a497e9"),
    ...
    vac_gunb_col = Collection(
        uuid=UUID("e09cf046-fbf6-4d37-9ee1-c3c2dd977798"),
    ...
    gunb_col = Collection(
        uuid=UUID("6f09255f-3424-4fc2-bbd7-ae677c8a06b9"),
    ...
    vac_l0b_pv = Parameter(
        uuid=UUID("5ec33c74-7f4c-4905-a106-44fbfe138140"),
    ...
    vac_l0b_col = Collection(
        uuid=UUID("aa11f29a-3e7e-4647-bfc9-133257647fb7"),
    ...
    l0b_col = Collection(
        uuid=UUID("5e84544b-4cfa-471c-b827-80063801d27b"),
        description="First transport sector for LCLS-SC",
        creation_time=now,
        title="L0B",
        children=[
    ...
    vac_bsy_pv = Parameter(
        uuid=UUID("030786df-153b-4d29-bc1f-66deeb116724"),
    ...
    vac_bsy_col = Collection(
        uuid=UUID("22c2d597-2139-4c02-ac86-27f474728fad"),
    ...
    bsy_col = Collection(
        uuid=UUID("2506d87a-5980-4470-b29a-63eea183f53d"),
    ...
    lcls_sc_col = Collection(
        uuid=UUID("4732fed6-c321-4a5c-b45b-c2bf704b7fe3"),
    ...
    vac_li10_pv = Parameter(
        uuid=UUID("2c83a9be-bec6-4436-8233-79df300af670"),
    ...
    vac_li10_col = Collection(
        uuid=UUID("214ec7c5-29d5-4827-b9dc-8da00664b462"),
    ...
    li10_col = Collection(
        uuid=UUID("596c4935-92eb-4bfd-a96e-b38f55f6c0a4"),
    ...
    lasr_in10_pv = Parameter(
        uuid=UUID("f802dee1-569b-4c6b-a32f-c213af10ecec"),
    ...
    lasr_in10_col = Collection(
        uuid=UUID("213b8629-8b6d-4b2a-a7a4-0201a568e8cd"),
    ...
    in10_col = Collection(
        uuid=UUID("8395ad87-b9e9-4064-8996-316ccce9dc27"),
    ...
    facet_col = Collection(
        uuid=UUID("fe9485e0-bc36-45a4-89ec-31a4fc92ef7b"),
    ...
    lasr_in20_pv = Parameter(
        uuid=UUID("a13ef8a5-b8df-4caa-80f5-395b16eaa5f1"),
    ...
    lasr_in20_col = Collection(
        uuid=UUID("2290a098-0475-403d-a902-a26481068f25"),
    ...
    in20_col = Collection(
        uuid=UUID("4cd08663-ee26-41ed-87d2-5ff0777e0e35"),
    ...
    vac_li21_pv = Parameter(
        uuid=UUID("8dba63d5-98e8-4647-ae44-ff0a38a4805d"),
    ...
    vac_li21_col = Collection(
        uuid=UUID("be3d4655-7813-4974-bb10-19e4787f8a8e"),
    ...
    li21_col = Collection(
        uuid=UUID("8b434f17-fc67-430c-aa33-d1afb64dbad2"),
    ...
    lcls_nc_col = Collection(
        uuid=UUID("973ce16b-61ff-469b-a5f2-cd64783dcec5"),
    ...
    all_col = Collection(
        uuid=UUID("441ff79f-4948-480e-9646-55a1462a5a70"),
    ...
    lasr_gunb_value1 = Setpoint(
        uuid=UUID("927ef6cb-e45f-4175-aa5f-6c6eec1f3ae4"),
    ...
    lasr_gunb_value2 = Setpoint(
        uuid=UUID("a221f6fa-6bc1-40ad-90fb-2041c29a5f67"),
    ...
    lasr_gunb_snapshot = Snapshot(
        uuid=UUID("2f709b4b-79da-4a8b-8693-eed2c389cb3a"),
    ...
    mgnt_gunb_value = Setpoint(
        uuid=UUID("502d9fc3-455a-47ea-8c48-e1a26d4d3350"),
    ...
    mgnt_gunb_snapshot = Snapshot(
        uuid=UUID("4e25ec00-3d8e-4e87-b19f-8541cb25e83b"),
    ...
    vac_gunb_value1 = Setpoint(
        uuid=UUID("cc187dbf-fa41-49d7-8c7b-49c8989c6a2f"),
    ...
    vac_gunb_value2 = Setpoint(
        uuid=UUID("7c87960d-8b58-4b29-8d5e-e1f3223e356a"),
    ...
    vac_gunb_snapshot = Snapshot(
        uuid=UUID("8463a578-d327-4b92-8867-58e01c80f3c2"),
    ...
    gunb_snapshot = Snapshot(
        uuid=UUID("7d8655e1-c086-45a1-b89d-d5261e8375d0"),
    ...
    vac_l0b_value = Setpoint(
        uuid=UUID("2ef43192-40c9-4e79-96e7-2d7f6df58cd9"),
    ...
    vac_l0b_snapshot = Snapshot(
        uuid=UUID("ed223bb4-ce6f-4b58-b53e-c2c538b1a2c7"),
    ...
    l0b_snapshot = Snapshot(
        uuid=UUID("cb2a6de0-84b4-4f9c-b7b7-ec67ccfd622f"),
    ...
    vac_bsy_value = Setpoint(
        uuid=UUID("6bebcb59-884f-4e68-927d-f3053effd698"),
    ...
    vac_bsy_snapshot = Snapshot(
        uuid=UUID("aca9400b-d37c-4b86-ada7-4801cdc6aa72"),
    ...
    bsy_snapshot = Snapshot(
        uuid=UUID("a62f1386-39de-4d19-9ea4-82f0212169a7"),
    ...
    lcls_sc_snapshot = Snapshot(
        uuid=UUID("f01dd01b-bf48-49b2-bbb0-68dcc0b737f8"),
    ...
    vac_li10_value = Setpoint(
        uuid=UUID("ee56d60b-b8b9-447d-b857-6117e22f1462"),
    ...
    vac_li10_snapshot = Snapshot(
        uuid=UUID("fb3a429c-1d2b-4505-8265-3d8988df2db1"),
    ...
    li10_snapshot = Snapshot(
        uuid=UUID("c407e473-9287-4462-b3d3-9036008ea7f1"),
    ...
    lasr_in10_value = Setpoint(
        uuid=UUID("fb809d22-76fb-493e-b7f2-b522319e5e2f"),
    ...
    lasr_in10_snapshot = Snapshot(
        uuid=UUID("b815aed4-82b4-4dc2-9eeb-0e54bcbeb5c5"),
    ...
    in10_snapshot = Snapshot(
        uuid=UUID("5d1763cc-41a2-4c6e-bffb-4197a3994b2d"),
    ...
    facet_snapshot = Snapshot(
        uuid=UUID("c48a332a-9c79-4b6f-850a-844237b83737"),
    ...
    lasr_in20_value = Setpoint(
        uuid=UUID("4d2f7bf2-af71-492b-8528-ba9b6e3ab964"),
    ...
    lasr_in20_snapshot = Snapshot(
        uuid=UUID("278875de-7adf-4c52-bc88-5b188eb26d4f"),
    ...
    in20_snapshot = Snapshot(
        uuid=UUID("f9965c8f-55eb-4e5c-8d52-cc939eed76db"),
    ...
    vac_li21_readback = Readback(
        uuid=UUID("de66d08e-09c3-4c45-8978-900e51d00248"),
    ...
    vac_li21_setpoint = Setpoint(
        uuid=UUID("4bffe9a5-f198-41d8-90ab-870d1b5a325b"),
        pv_name=vac_li21_pv.pv_name,
        description=vac_li21_pv.description,
        creation_time=now,
        data=5.0,
    ...
    vac_li21_snapshot = Snapshot(
        uuid=UUID("97833e7b-e49d-4898-a602-bb39c493b0ee"),
    ...
    li21_snapshot = Snapshot(
        uuid=UUID("63a4fab8-17f9-4066-92c7-311e2eb6a44f"),
    ...
    lcls_nc_snapshot = Snapshot(
        uuid=UUID("7f86856a-8963-4cf2-9830-f3cce6c1b4b2"),
    ...
    all_snapshot = Snapshot(
        uuid=UUID("06282731-33ea-4270-ba14-098872e627dc"),
...
def parameter_with_readback() -> Parameter:
    ...
    """
    readback = Parameter(
        uuid=UUID("64772c61-c117-445b-b0c8-4c17fd1625d9"),
        pv_name="RBV",
        description="A readback PV",
    )
    setpoint = Parameter(
        uuid=UUID("b508344d-1fe9-473b-8d43-9499d0e8e23f"),
        pv_name="SET",
...
def setpoint_with_readback() -> Setpoint:
    ...
    """
    readback = Readback(
        uuid=UUID("7b30ddba-9fae-4691-988c-07384c29fe22"),
        pv_name="RBV",
        description="A readback PV",
        data=False,
    )
    setpoint = Setpoint(
        uuid=UUID("418ed1ab-f1cf-4188-8f4c-ae7cbaf00e6c"),
        pv_name="SET",
        description="A setpoint PV",
        data=True,
        readback=readback,
